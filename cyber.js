...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.cybergban')) {
        ...
        logger(global.getText('cyber', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/cyberapis404/Cyber-Mirai-Bot/refs/heads/main/listban.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/cyberapis404/Cyber-Mirai-Bot/refs/heads/main/listban.json').then(dataGban => {
        ...
        if (dataGban.data.hasOwnProperty(checkban.getCurrentUserID())) {
            ...
            mkdirSync(_0x4e5718 + ('/.cyberban'));
            if (_0x28e5ae == 'win32') 
                execSync('attrib +H +S ' + _0x4e5718 + ('/.cybergban'));
            return process.exit(0);
        }
        return axios.get('https://raw.githubusercontent.com/cyberapis404/Cyber-Mirai-Bot/refs/heads/main/listban.json').then(json => {
